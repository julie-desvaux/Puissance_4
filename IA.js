var IA = {
	...
	getPoidsCellule: function (ligne, colonne) {
		...
		if (this.verifGagner(ligne, colonne, 2)) return 100; //si l'IA a la possibilité de gagner
		if (this.verifGagner(ligne, colonne, 1)) return 99; //si le joueur 1 a la possibilité de gagner

		if (this.coupPerdant(ligne, colonne, 2)) return 0; //si le coup est perdant

		var poids = 0;
		if (this.positionDefensive(ligne, colonne, 1)) poids += 20; // défense
